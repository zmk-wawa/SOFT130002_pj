...
//hasOwnProperty——判断是否y
//打开第二个界面时，localStorage中不为空，则将上一次存的arr取出赋值给当前arr
console.log( JSON.parse(localStorage.getItem('logAccount')))
var arr= localStorage.hasOwnProperty('logAccount') ?JSON.parse(localStorage.getItem('logAccount')): []

//获取操作元素和内容
var get=document.getElementById("trans_cookie");
var username =trans_cookie.value;  //获取标题
